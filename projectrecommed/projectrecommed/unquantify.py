...
def data_unquantification(ls):
    ...
    # not required if quadata_unquantificationdata_unquantificationlification is 0 else qualification -1 to retrieve value using job_qualification list
    qualification = ['Notdata_unquantification Required' if not ls[9] else f'{job_qualification[ls[9]-1]}']
